...
val stats: (string * decimal)[] =
  [|("4.2", 211882M); ("4.1", 104785M); ("4.0", 54979M); ("3.3", 828925M);
    ("3.2", 21329M); ("3.1", 210337M); ("3.0", 390912M); ("2.4", 421503M);
    ("2.3", 498842M); ("2.2", 288773M); ("2.1", 28961M); ("2.0", 88561M);
    ("1.1", 78718M); ("1.0", 26596M)|]*)
(**
